    ...
    <div className="py-16">
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <Slider {...sliderSettings}>
          {/* Slide 1 */}
          <div className="flex flex-col-reverse lg:flex-row items-center lg:ml-20 lg:mt-10">
            ...
            {/* Right Column - Image */}
            <div className="lg:w-1/2 lg:-mt-52 mx-auto flex justify-center lg:justify-end relative lg:ml-96">
              ...
              <img
                ...
                src="https://spprep.org/wp-content/uploads/2024/11/FinAid-Scholarships.jpg"
                alt="Slide 1"
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center lg:ml-20 lg:mt-10">
            ...
            {/* Right Column - Image */}
            <div className="lg:w-1/2 relative flex justify-center lg:-mt-52 mx-auto lg:justify-end lg:ml-96">
              ...
              <img
                ...
                src="https://coenet.org/wp-content/uploads/2023/03/AdobeStock_546791704.jpeg"
                alt="Slide 2"
                className="rounded-full h-80 w-80 object-cover"
              />
            </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center lg:ml-20 lg:mt-10">
            ...
            <div className="lg:w-1/2 relative flex justify-center lg:-mt-52 mx-auto lg:justify-end lg:ml-96">
              ...
              <img
                ...
                src="https://www.sunrisecu.mb.ca/assets/img/Images/Blog/the-importance-of-applying-for-scholarships.jpg"
                alt="Slide 3"
                className="rounded-full h-80 w-80 object-cover"
              />
            </div>
