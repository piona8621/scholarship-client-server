...
//           {reviews.map((review) => (
//             <div key={review._id} className="card border p-4">
//               <h3>{review.universityName}</h3>
...
const AllReviews = () => {
  ...
  return (
    <div className="p-6">
      <Helmet>
              <title> ProFellow | Reviews </title>
            </Helmet>
      <h2 className="text-2xl text-green-500 font-bold text-center mb-6">All Reviews</h2>
      {loading ? (
